...
//		System.out.println("错误代码："+xmlentity.getError());
    ...
    public static void sendMail(String fromMail, String user, String password,
        ...
        message.setRecipient(javax.mail.Message.RecipientType.TO, new InternetAddress(toMail));//设置收件人,并设置其接收类型为TO
...
//        Transport transport = session.getTransport("smtp");
	...
	public String SendMessages(String email) throws Exception {
        ...
        sendMail("forsshmail@sina.com", "forsshmail", "123456789",
                email,
                new String("ssh网站验证邮件"),
                new String("您的验证码为")+checkNumber);
		return checkNumber;
	}
	...
	public String SendSMS(String phoneNumber,int random){
		...
		String content ="您的验证码"+random+"【梦马可栖】";
		 //发送调用
